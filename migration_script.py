...
MODELS_ORDER = [
    ...
    'users.customtoken',
    'sessions.session',
    'Инвентаризация.department',
    'Инвентаризация.warehousemanager',
    'Инвентаризация.typecompyuter',
    'Инвентаризация.motherboard',
    'Инвентаризация.motherboardmodel',
    'Инвентаризация.cpu',
    'Инвентаризация.generation',
    'Инвентаризация.frequency',
    'Инвентаризация.hdd',
    'Инвентаризация.ssd',
    'Инвентаризация.ramsize',
    'Инвентаризация.gpu',
    'Инвентаризация.printer',
    'Инвентаризация.scaner',
    'Инвентаризация.typewebcamera',
    'Инвентаризация.modelwebcamera',
    'Инвентаризация.monitor',
    'Инвентаризация.disktype',
    'Инвентаризация.ramtype',
    'Инвентаризация.programlicense', 
    'Инвентаризация.program',
    'Инвентаризация.os',
    'Инвентаризация.mfo',
    'Инвентаризация.section',
    'Инвентаризация.compyuter',
    'Инвентаризация.historicalcompyuter',
    'Инвентаризация.computeragent',
    'admin.logentry',
]
